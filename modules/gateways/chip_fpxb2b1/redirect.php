...
if ( $params['paymentmethod'] != 'chip_fpxb2b1' ) {
...
$send_params = array(
  'success_callback' => $system_url . 'modules/gateways/callback/chip_fpxb2b1.php?invoiceid=' . $get_invoice_id,
    ...
    if ($params[$key] == 'on') {
      ...
      if (end($key_array) == 'b2b1') {
        $send_params['payment_method_whitelist'][] = 'fpx_b2b1';
          ...
          $send_params['payment_method_whitelist'][] = 'duitnow_qr';
      } else {
...
Session::set( 'chip_fpxb2b1_' . $params['invoiceid'], $payment['id'] );
