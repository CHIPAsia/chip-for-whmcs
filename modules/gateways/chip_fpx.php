...
function chip_fpx_link($params)
{
  ...
  $html = '<p>'
    ...
    . '<br />'
    . '<a href="' . $params['systemurl'] . 'modules/gateways/chip/redirect.php?invoiceid=' . $params['invoiceid'] . '&gateway=chip_fpx">'
    . '<img height="44px" src="' . $params['systemurl'] . 'modules/gateways/chip_fpx/paywithfpx.png" title="' . Lang::trans('Pay with FPX (Online Banking)') . '">'
    . '</a>'
    . '<br />'
...
function chip_fpx_capture($params)
{
  ...
  $purchase_params = array(
    'success_callback' => $system_url . 'modules/gateways/callback/chip_fpx.php?capturecallback=true&invoiceid=' . $params['invoiceid'],
  ...
  Capsule::select("SELECT GET_LOCK('chip_fpx_payment_$payment_id', 10);");
