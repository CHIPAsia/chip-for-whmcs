...
if (\openssl_verify($content, \base64_decode($_SERVER['HTTP_X_SIGNATURE']), \ChipActionFPX::retrieve_public_key($params), 'sha256WithRSAEncryption') != 1) {
...
\ChipActionFPX::complete_payment($params, $payment);
