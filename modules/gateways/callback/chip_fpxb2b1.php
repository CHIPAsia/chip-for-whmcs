...
require_once __DIR__ . '/../chip_fpxb2b1/api.php';
...
if (\openssl_verify($content, \base64_decode($_SERVER['HTTP_X_SIGNATURE']), \ChipActionFPXB2B1::retrieve_public_key($params), 'sha256WithRSAEncryption') != 1) {
...
\ChipActionFPXB2B1::complete_payment($params, $payment);
