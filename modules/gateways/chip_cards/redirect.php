...
if ( $params['paymentmethod'] != 'chip_cards' ) {
...
$send_params = array(
  'success_callback' => $system_url . 'modules/gateways/callback/chip_cards.php?invoiceid=' . $get_invoice_id,
...
Session::set( 'chip_cards_' . $params['invoiceid'], $payment['id'] );
